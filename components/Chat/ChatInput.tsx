  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent pt-6 dark:border-white/20 bg-gradient-to-b from-transparent via-white to-white dark:via-[#343541] dark:to-[#343541] md:pt-2">
      ...
      <div className="px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6">
        <a
          href="https://github.com/djalmahenry/difinity-chat"
          target="_blank"
          rel="noreferrer"
          className="underline"
        >
        ...
        .{' '}
        {t(
          "Difinity Chat is a model similar to ChatGPT for using the Open AI API. Enter your personal key to use the chat.",
        )}
      </div>
    </div>
  );
